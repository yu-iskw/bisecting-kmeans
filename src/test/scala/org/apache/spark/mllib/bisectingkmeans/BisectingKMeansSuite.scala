...
class BisectingKMeansSuite extends SparkFunSuite with MLlibTestSparkContext {
  ...
  test("getChildrenCenter") {
    ...
    val stats = Map[BigInt, BisectingClusterNodeStat](
      BigInt(2) -> new BisectingClusterNodeStat(2, BV[Double](1.0, 1.0) * 2.0, BV.zeros[Double](2)),
      BigInt(3) -> new BisectingClusterNodeStat(2, BV[Double](2.0, 2.0) * 2.0, BV.zeros[Double](2))
    )
  ...
  test("should assign each data to new clusters") {
    ...
    val newClusters = Map(
      BigInt(4) -> new BisectingClusterNodeStat(3L, BV[Double](1.0, 1.0) :* 3.0, BV[Double](1.0, 1.0)),
      BigInt(5) -> new BisectingClusterNodeStat(3L, BV[Double](4.0, 4.0) :* 3.0, BV[Double](1.0, 1.0)),
      BigInt(6) -> new BisectingClusterNodeStat(3L, BV[Double](7.0, 7.0) :* 3.0, BV[Double](1.0, 1.0)),
      BigInt(7) -> new BisectingClusterNodeStat(3L, BV[Double](10.0, 10.0) :* 3.0, BV[Double](1.0, 1.0))
    )
